...
Oppia is an online learning tool that enables anyone to easily create and share interactve activities (called 'explorations'). These activities simulate a one-on-one conversation with a tutor, making it possible for students to learn by doing while getting feedback.
